    ...
    <div className="bg-[#f8fafc] pt-24">
      <section className="py-20 border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6">
          <AnimatedSection>
            <p className="text-[11px] font-semibold text-[#0f766e] uppercase tracking-[0.14em] mb-4">Contact</p>
            ...
            <div className="lg:col-span-2 space-y-5">
              <AnimatedSection>
                <a href="mailto:sandy.show18@gmail.com"
                  className="flex items-center gap-4 p-5 rounded-2xl border border-slate-200 card-hover group bg-white"
                  >
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(15,118,110,0.1)" }}>
                    <Mail size={18} className="text-[#0f766e]" />
                  </div>
                  <div>
                    <p className="text-slate-900 font-medium text-sm mb-0.5">Email</p>
                    <p className="text-slate-500 text-sm group-hover:text-[#0f766e] transition-colors">
              ...
              <AnimatedSection delay={0.05}>
                <a href="https://www.linkedin.com/in/sandeep-kurapati-5b81b811a/" target="_blank" rel="noopener noreferrer"
                  ...
                  >
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(15,118,110,0.1)" }}>
                    <ExternalLink size={18} className="text-[#0f766e]" />
                  </div>
                  <div>
                    <p className="text-slate-900 font-medium text-sm mb-0.5">LinkedIn</p>
                    <p className="text-slate-500 text-sm group-hover:text-[#0f766e] transition-colors">
              ...
              <AnimatedSection delay={0.15}>
                <div className="p-5 rounded-2xl border border-slate-200 bg-slate-50">
                  ...
                  <p className="text-slate-600 text-sm">I read every message and reply within 48 hours. If your question is about restaurant operations, commerce platforms, or product architecture, I&apos;ll always respond — even if I&apos;m not the right person for the role.</p>
                </div>
              </AnimatedSection>
            </div>
                ...
                <div className="p-6 sm:p-8 rounded-2xl border border-slate-200 bg-white">
                  {submitted ? (
                    <div className="text-center py-10">
                      ...
                      <h3 className="text-slate-900 font-semibold text-lg mb-2">Opening your mail client</h3>
                      <p className="text-slate-600 text-sm mb-4">Your message has been pre-filled. Hit send and I&apos;ll reply within 48 hours.</p>
                      <p className="text-slate-500 text-[11px]">Or email directly: sandy.show18@gmail.com</p>
                    </div>
                  ) : (
                    <>
                      <h2 className="text-slate-900 font-semibold text-lg mb-1">Send a message</h2>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="grid sm:grid-cols-2 gap-5">
                          <div>
                            ...
                            <input id="contact-name" type="text" required value={form.name}
                              ...
                              className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-[#0f766e]/50 transition-colors bg-white"
                               />
                          </div>
                          <div>
                        ...
                        <div>
                          ...
                          <textarea id="contact-message" required rows={6} value={form.message}
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-[#0f766e]/50 transition-colors resize-none bg-white"
                             />
                        </div>
                        <button type="submit"
                          className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#00d4aa] text-[#0f172a] font-semibold hover:bg-[#00b891] transition-all duration-200">
